    ...
    <div className="">
      <div className="flex h-screen justify-center items-center">
        <div className="bg-gradient-to-b from-bubblegum-400 to-cream-400 rounded-lg w-3/5 py-2">
          <h4 className="text-center text-black text-2xl my-6">
            Create Aspiration
          </h4>
          <div className="">
            <form className="text-slate-900">
              <div className="grid md:grid-cols-3 grid-cols-1">
                <div className="flex flex-col ">
                  ...
                  <h3 className=" text-black text-xl text-white pt-1">
                    Priority
                  </h3>
                  ...
                  <input
                    ...
                    min="1"
                    max="9"
                    className="w-32 text-rich-200 mx-auto my-1 rounded-sm px-1"/>
                    </div>
                <div className="flex flex-col">
                  <input
                    // change the size
                  ...
                  <label
                    for="img"
                    className=" cursor-pointer bg-rich-300 hover:bg-rich-200 rounded-md p-1 ease-in-out duration-300 transition-all hover:text-cream-300 mx-auto my-1 rounded-sm px-1 text-white"
                  >
                    Choose an image
                  </label>
              ...
              <button
                className="text-sky-50 flex justify-center my-6 bg-rose-300 hover:bg-bubblegum-400 transition-all duration-300 mx-auto p-1 rounded-md"
                type="submit"
              >
                Submit
              </button>
